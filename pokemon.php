      ...
      <article id="pokemon">
          ...
          <table border="1" cellpadding="5" id="centerMargin">
            ...
            <?php foreach ($pokemon as $poke): ?>
              <tr>
                ...
                <td><a href="#"
                    onClick="updatePokemon(<?php echo $poke['pokeID']; ?>, '<?php echo htmlspecialchars($poke['pokeName']); ?>', <?php echo $poke['isBaby']; ?>, '<?php echo htmlspecialchars($poke['pokeRarity']); ?>')">Edit</a>
                </td>
                <td><a href="#"
                    onclick="deletePokemon(<?php echo $poke['pokeID']; ?>, '<?php echo htmlspecialchars($poke['pokeName']); ?>')">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </table>
        ...
        <div id="update" style="display: none">
          <form method="POST" action="pokemon.php">
            ...
            <fieldset class="fields">
              <label> Pokemon Name </label> <input type="text" name="pokeName" id="updatePokeName"
                style="margin-bottom: 10px">
              <br>
              <label> Is it a baby Pokemon? </label> <select name="isBaby" id="updateIsBaby"
                style="margin-bottom: 10px">
                <option value="0">False</option>
                <option value="1">True</option>
              </select>
