...
CREATE
OR REPLACE TABLE People (
	peopleID int AUTO_INCREMENT UNIQUE NOT NULL,
	peopleName varchar(255) NOT NULL,
	affiliationID int,
	PRIMARY KEY (peopleID),
	FOREIGN KEY (affiliationID) REFERENCES Affiliations(affiliationID) ON DELETE
	SET
		NULL
);
...
CREATE
OR REPLACE TABLE Pokemon_People (
	pokeID int NOT NULL,
...
CREATE
OR REPLACE TABLE Pokemon_Types (
	pokeID int NOT NULL,
	typeID int NOT NULL,
...
CREATE
OR REPLACE TABLE People_Battles (
	peopleBattleID INT AUTO_INCREMENT UNIQUE NOT NULL,
	peopleID int,
	battleID int NOT NULL,
	battleResult varchar(255) NOT NULL,
	UNIQUE (peopleID, battleID),
	-- make sure the same person isn't in the same battle more than once
	PRIMARY KEY (peopleBattleID),
	FOREIGN KEY (peopleID) REFERENCES People(peopleID) ON DELETE
	SET
		NULL ON UPDATE CASCADE,
		-- battles can remain even if a person is deleted
...
INSERT INTO
	People_Battles (peopleID, battleID, battleResult)
VALUES
	(1, 1, "Won"),
	(2, 1, "Lost"),
	(1, 2, "Lost"),
