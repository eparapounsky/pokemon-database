...
-- Citation for table definitions:
-- Date: 10/28/2024
...
CREATE OR REPLACE TABLE People (
    ...
    peopleName varchar(255) UNIQUE NOT NULL,
    affiliationID int,
...
-- Citation for sample data insertions:
-- Date: 10/24/2024
...
VALUES 
	...
	("Professor", "Researcher", "Pokemon experts");
...
VALUES 
	...
	("Samuel Oak", (SELECT affiliationID
				FROM Affiliations
				WHERE affiliationType = "Professor"
				AND affiliationRank = "Researcher")),
	("Nessa", NULL); 
